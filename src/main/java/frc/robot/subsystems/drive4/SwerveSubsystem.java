...
package frc.robot.subsystems.drive4;
...
public class SwerveSubsystem extends SubsystemBase
{
  ...
  public SwerveSubsystem(File directory)
  {
    ...
    try
    {
      swerveDrive = new SwerveParser(directory).createSwerveDrive(DriveConstants.maxLinearVelocity);
  ...
  {
    swerveDrive = new SwerveDrive(driveCfg, controllerCfg, DriveConstants.maxLinearVelocity);
  }
